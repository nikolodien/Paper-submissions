...
to unify aspect and sentiment was proposed by Jo and Oh~\shortcite{jo2011aspect}. Most of 
the unsupervised methods discussed here operate at the word level. Due to this they lose out
on the information provided by phrases which may lead to incorrect classification.
...
topics. Instead of adding rules, we can make use of machine learning to detect the subjective nature of a phrase.
